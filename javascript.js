...
function showpopu(x) {
    ...
    document.querySelector('.jobtitle').innerHTML = mentorjson[x - 2].position;
    console.log("static" + mentorjson[x - 2].imageUrl)
    desc.innerHTML = mentorjson[x - 2].description;
    hu.src = "static" + mentorjson[x - 2].imageUrl;
    naam.innerHTML = mentorjson[x - 2].name;
    document.querySelector('.pop').style.display = 'flex';


}
for (let k = 1; k <= 42; k++) {
    var imageme = document.getElementById("hv" + (k));
...
function showup(x) {
    if (x == 1) {
        ...
        var div = document.querySelectorAll('.mentorimgsphone')
        div[2].style.display = 'flex';
        div[3].style.display = 'flex'
        div[4].style.display = 'flex'
        ...
        div[9].style.display = 'flex'
        div[10].style.display = 'flex'
