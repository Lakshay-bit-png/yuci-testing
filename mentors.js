...
function func(x){
    document.querySelectorAll('.default')[x].children[0].classList.add('img2')
    document.querySelector('.txt'+x).children[0].classList.add('display2')
    document.querySelector('.txt'+x).classList.add('display')
   
}
function func2(x){
    document.querySelectorAll('.default')[x].children[0].classList.remove('img2')
    document.querySelector('.txt'+x).children[0].classList.remove('display2')
    document.querySelector('.txt'+x).classList.remove('display')
...
for(var i=0;i<40;i++){
    ...
    img.src='./static/mentors/'+(i+1)+'.jpg';
    img.classList.add('img')
    
    newDiv.append(img);
    var textdiv=document.createElement('div')
    textdiv.classList.add('properties')
    textdiv.classList.add('txt'+i)
    textdiv.textContent=mentorjson[i].name;

   var innerdiv=document.createElement('div');
   innerdiv.textContent=mentorjson[i].position;
